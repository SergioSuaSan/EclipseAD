...
<a name="up"></a>
	<a href="#up">
		<i class="fa fa-arrow-up btn btn-danger position-fixed end-0 bottom-0 m-4" aria-hidden="true"></i>
	</a>
	<div class="container bg-black shadow p-0">
						...
						<div class="card flex-fill bg-dark-subtle">
							<div class="row d-flex bg-dark-subtle m-0 rounded">
								...
								<div class="col-4 m-0 p-0">
									<img class="card-img-top m-0 rounded" src="${personaje.icono.ruta}.${personaje.icono.extension}" alt="Title" width = "200" height= "200"/>
								</div>
		...
		<footer>
			<!-- place footer here -->
			<h2 class="text-white bg-danger text-center p-3 m-0">&copy; Sergio</h2>
		</footer>
	</div>
